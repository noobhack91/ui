            ...
            if (container) {
                ...
                if (tables.length > 0) {
                    ...
                    Array.from(rows).forEach(row => {
                        ...
                        const column0 = columns[0] as HTMLElement;
                        const column1 = columns[1] as HTMLElement | undefined;

                        // Calculate heights of each <td>.
                        const height0 = column0.offsetHeight;
                        const height1 = column1 ? column1.offsetHeight : 0;
